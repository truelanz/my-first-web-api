...
@Configuration
@EnableOpenApi //<--Usa-se EnableOpenApi
@EnableSwagger2 // <-- Não é mais necessário a utilização do EnableSwagger no springfox 3.0.0
...
//-----------------	//CONFIGURAÇÕES BASE DA INTERFACE DO SWAGGER\\ ----------------------\\
    ...
    private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.license("Licença - truelanz");
		apiInfoBuilder.licenseUrl("http://www.truelanz.com.br");
